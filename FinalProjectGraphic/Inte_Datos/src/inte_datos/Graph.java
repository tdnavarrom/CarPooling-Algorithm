...
public class Graph {
    ...
    public void getSolution(int num_Nodes, float p){
      ...
      try {
          ...
          JOptionPane.showMessageDialog(null,"Number of cars we have to use: " + tempArr.length);
          JOptionPane.showMessageDialog(null,"Total reduction of cars: " + (num_Nodes - tempArr.length)+"\n WOW with your help we're are going to safe the world!!");
          escritor.close();
      }
